...
def createAccount():
    ...
    if accountNo != None:
        ...
        displayAsTable(data=AccountDB.getAccountById(accountNo), title="New Account")
...
def getAllAccounts():
    ...
    displayAsTable(data=allAccounts, title="All Accounts")
...
def chooseAccount()->int:
    ...
    displayAsTable(data=accounts, title="Choose from the following accounts")
